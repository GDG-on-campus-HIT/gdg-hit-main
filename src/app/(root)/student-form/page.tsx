...
//   redirect("/student-form/[id]"); // 👈 replace "general" with your real id
// }
...
// export default async function StudentFormRoot() {
//   const session = await getServerSession();

//   if (!session || !session.user) {
//     redirect("/login"); // no user, go to login
//   }

//   const userId = session.user.id; // 👈 each user gets their own id
//   redirect(`/student-form/${userId}`);
// }
